...
import SaveToWallet from "../common/SaveToWallet";
import Registration from "../common/registration";
import SetupDoorwayPersonal from "./setupDoorway";
...
const steps = [
  ...
  {
    step: 2,
    label: "Customize Doorway",
    component: <SetupDoorwayPersonal />,
  },
  {
    step: 3,
    label: "Save to Wallet",
    component: <SaveToWallet />,
  },
];
