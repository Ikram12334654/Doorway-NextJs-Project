  ...
  return (
    <div className="w-screen h-screen flex flex-row md:flex-col">
      ...
      <div className="h-screen w-1/2  flex justify-center items-center  md:hidden bg-themeColor" >
        ...
        <div className="mx-auto w-70p h-max p-10 items-center md:w-[90%] sm:w-[98%] sm:p-0 md:p-8 lg:p-2 justify-center 2xl:w-[60%]  lg:w-[80%]  md:w-[90%] sm:w-[98%] sm:p-4  flex flex-col  " style={{margin:"auto"}}>
          ...
          {({ setFieldValue, isSubmitting }) => (
            <Form className="w-full">
              ...
              {!showPasswordField && !loading && (
                <div className="mb-2">
                  <label htmlFor="email" className="block font-medium  md:text-mde">
                    Email
                  </label>
                  <Field
                    id="email"
              ...
              {showPasswordField && !loading && (
                <div> {/* Wrap the password field and button in a div */}
                  <div className="mb-2">
                  <label htmlFor="email" className="block font-medium md:text-mde ">
                    Email
                  </label>
                  ...
                  <div className="mb-3 mt-5 relative">
                      <label htmlFor="password" className="block font-medium md:text-mde">
                        Password
                      </label>
                      <Field
                  ...
                  {!showPasswordField && (
                    <div className='w-full flex flex-col item-center .justify-center mt-5 sm:text-sm'>
                       ...
                       <button className="w-full p-2  mt-5 border border-black hover:bg-[#F5F5F5FF] flex flex-row items-center ">
                          <Image src={googleLogo} alt="google logo" className="h-[15px] w-auto mr-3 ml-10 sm:ml-1 sm:h-[11px] lg:ml-2 " />
                          <span>Login with Google</span>
                       </button>
                       <button className="w-full p-2  mt-5 border border-black hover:bg-[#F5F5F5FF] flex flex-row items-center ">
                          <Image src={applelogo} alt="google logo" className="h-[15px] w-auto mr-3  ml-10 sm:ml-1 sm:h-[11px] lg:ml-2" />
                          <span>Login with Apple</span>
                       </button>
                       <button className="w-full p-2  mt-5 border border-black hover:bg-[#F5F5F5FF] flex flex-row items-center ">
                          <Image src={linkedInlogo} alt="google logo" className="h-[15px] w-auto mr-3  ml-10 sm:ml-1 sm:h-[11px] lg:ml-2" />
