  ...
  return (
    <div className="w-full h-[100%]  justify-center">
      <div className="flex flex-row lg:flex-col  w-[992px] lg:w-[480px] sm:w-[320px] m-auto ">
        <div className="w-[50%] p-6  border flex flex-col mt-5 lg:w-[100%]">
                      ...
                      >
                        ...
                        <div className="HeaderImage HeaderImage--logo flex-item width-fixed flex-container justify-content-center align-items-center">
                          <img
                            ...
                            loading="lazy"
                          />
                          <span className="Header-businessLink-label hidden">
                            Back
                          </span>
                        </div>
                      </div>
          ...
          <div className="w-[90%] justify-center m-auto mt-5 text-left flex flex-col">
            {data === "300" ? (
              <>
                ...
                <span className="text-[32px] text-default font-semibold">
                  30 days free
                </span>
                <span className="text-[16px] text-gray-500 font-semibold">
                  Then US$300.00 per month
                </span>
                <span className="text-[16px] text-gray-500 font-semibold mt-2">
                  100 cards, 20 trees planted per month, Cardholder permissions
                </span>
              </>
            ) : (
              <>
                ...
                <span className="text-[16px] text-gray-500 font-semibold">
                  Then US$750.00 per month
                </span>
                <span className="text-[16px] text-gray-500 font-semibold mt-2">
                  500 cards, 50 trees planted per month, 5 admins
                </span>
              </>
            )}
          </div>
        ...
        <div
          className="w-[50%] p-6 flex flex-col lg:w-[100%]  h-screen "
          style={{ boxShadow: "-10px 0 15px -8px rgba(0, 0, 0, 0.1)" }}
        >
          <div className="flex flex-col  justify-center w-[80%] mr-auto ml-auto border-black ">
            {data === "300" && (
              <div className='cursor:pointer hover:bg-["#7CF1A7FF"] bg-themeColor justify-center p-2 flex flex-row text-black  item-center text-center mt-2  h-[40px] rounded-[4px] w-[100%] space-x-4'>
                <span className="text-base font-semibold">Pay with</span>{" "}
                <PayWithSvg />
              </div>
            )}
            {data === "300" && (
              <div className="relative flex items-center py-8">
                ...
                <p className="mx-4 text-gray-400 text-[14px] font-normal">
            ...
            <div className="flex flex-col shadow-md">
              <label className="text-left text-base text-gray-600">
                Card Confirmation
              </label>
            ...
            <div className="flex flex-col w-[100%]  mt-6">
              <label className="text-left text-base text-gray-600 mb-1">
                Country or region
              </label>
              <div className="relative w-full shadow-md ">
                {/* Flag Display */}
                {formData.regionOrCountry && (
                  <div className="absolute top-1/2 left-3 transform -translate-y-1/2 flex items-center"></div>
                )}
            ...
            {data === "300" && (
              <div className="flex flex-col w-full mt-6 shadow-md">
                <div className="relative w-full border rounded-md border-gray-400">
                  <div className="flex flex-col mb-4 p-1 ">
                    ...
                    >
                      ...
                      faster on Dorway Ltd and everywhere Link is accepted.
                    </div>
                  </div>
                </div>
              </div>
            ...
            <button
              className="w-[100%] p-2 text-base text-black bg-themeColor rounded-md mt-4 font-semibold "
              onSubmit={onSubmit}
            >
              Start trail
            </button>
