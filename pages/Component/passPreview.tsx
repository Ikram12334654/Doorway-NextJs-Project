                    ...
                    <div className="mt-3 ml-3 w-1/6">
                      ...
                      >
                        ...
                        ></path>
                          ...
                          <img src={data?.topLeftImage} alt="top Image" className="max-w-full h-auto m-auto" />
                    ...
                    <div className="items-center justify-center overflow-hidden flex aspect-[1033/407] my-[15px]">
                      <span className="flex items-center w-full block aspect-[3/1]">
                        <div className="mx-auto w-max text-[2.5rem] border-white text-center">
                          {data.stripeImage!=='' ?  <img src={data?.stripeImage} alt="top Image" className="max-w-full h-auto m-auto" />:"Doorway"}
                ...
                >
                  <div className="flex flex-col h-full justify-between pb-6">
                    <div className="mt-3 ml-3 w-1/6">
                      <span className="block w-6  mt-3 ml-3 w-1/6">
                        {data.topLeftImage!=='' ? (
                         <img src={data?.topLeftImage} alt="top Image" className="w-full h-auto m-auto" />
                        ) : (
                    ...
                    <span className="flex items-center  w-full block aspect-[3/1]">
                      <div className="mx-auto w-max text-[2.5rem] border-white text-center">
                        {data.stripeImage===""?"Doorway": <img src={data?.stripeImage} alt="top Image" className="max-w-full h-auto m-auto" />}
                      </div>
                    </span>
                  </div>
                  </div>
