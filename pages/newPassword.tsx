              ...
              <Form className="w-full">
                ...
                { (
                  <div className="mb-2">
                      ...
                      <label htmlFor="newPassword" className="block font-medium md:text-mde">
                        New Password
                      </label>
                      <Field
                ...
                { (
                   <div className="mb-2">
                   <div className="mb-3 mt-5 relative">
                   <label htmlFor="confirmPassword" className="block font-medium md:text-mde">
                     Confirm Password
                   </label>
                   <Field
                     type={showPassword ? "text" : "password"}
                ...
                {(
                 <button
                 type="submit"
                 className={`w-full p-2 mt-2 text-center justify-center align-center text-white rounded-[6px] min-h-[40px] ${!isValid || isSubmitting || isDisabled ? 'bg-gray-400' : 'bg-themeColor'}`}
                 disabled={!isValid || isSubmitting || isDisabled}
               >
                 {loading ? <LoadingSpinner size={25} color={'primary'}/> : 'Create Password'}
               </button>
                )}
              </Form>
            )}
