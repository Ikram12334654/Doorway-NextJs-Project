...
const MyAccount: React.FC = () => {
    ...
    const handleChange = (event: React.MouseEvent<Element> | React.KeyboardEvent<Element> | React.FocusEvent<Element, Element>, value: string | null) => {
        if (value) {
                    ...
                    <div className='pt-[80px] flex flex-col gap-20'>
                            ...
                            <div className="flex pb-[24px] border-b border-gray-200">
                                <div className="flex-grow flex flex-col gap-[12px]">
                                    <div className="flex gap-[12px]">
                                        <span className="text-regular font-semibold text-gray-950">Account Details</span>
                                    </div>
                                    <div>
                                        <span className="text-petite font-regular text-gray-500">Manage personal information and settings</span>
                                    </div>
                                </div>
                                <div className="flex items-center">
                                    <div className="inline-flex rounded-[6px] text-petite font-semibold justify-center gap-[6px] transition-all duration-500 ease-in-out px-[12px] py-[6px] focus:border-[2px] text-white bg-brand-500 hover:bg-brand-400 focus:border-brand-200 cursor-pointer"
                                        role='button'
                                        onClick={toggleModal}>
                        ...
                        <div className="flex flex-col gap-6">
                                ...
                                <div className="flex-grow flex flex-col gap-[12px]">
                                    ...
                                    <div>
                                        <span className="text-petite font-regular text-gray-500">
                                            Keep your account secure by requiring a verification code for each login
                                        </span>
                                    </div>
                                </div>
                                <div className="flex items-center">
                                    {/* Setup 2FA Button */}
                                    <div className="inline-flex rounded-[6px] text-petite font-semibold justify-center gap-[6px] transition-all duration-500 ease-in-out px-[12px] py-[6px] focus:border-[2px] text-white bg-brand-500 hover:bg-brand-400 focus:border-brand-200 cursor-pointer"
                                    role='button' onClick={toggleModal1}>
                            ...
                            <div className="bg-gray-50 w-full px-6 py-12 rounded-[12px] flex flex-col items-center gap-6">
                                ...
                                <div className="inline-flex rounded-[6px] text-petite font-semibold justify-center gap-[6px] transition-all duration-500 ease-in-out px-[15px] py-[7px] border-[1px] text-gray-700 border-gray-100 bg-white hover:bg-gray-50 focus:border-[2px] focus:border-gray-100 cursor-pointer"
                                role='button' onClick={toggleModal1}>
                                    <span className="whitespace-nowrap">Setup 2FA</span>
                                </div>
                            </div>
