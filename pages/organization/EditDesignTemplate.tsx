...
import PassPreview from "../Component/passPreview";
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="flex items-start gap-4 mb-6 w-[90%] m-auto mt-2 ">
        <button
          onClick={() => router.push("/organization/designtemplate")}
      ...
      <div className="flex flex-col min-md:flex-row gap-[44px] min-md:gap-[75px] items-center min-md:items-start justify-center p-5">
        ...
        {loader === false && <div className={`width:330px`}>
          <div className="block">
            <PassPreview
              values={{
        ...
        {loader == false && <div className="w-[330px] flex flex-col gap-[42px]">
          ...
          <div className="grow flex flex-col gap-[7px]">
              ...
              <input
                ...
                // Assuming setTemplateName is defined in your component
                className="bg-[#F2F5F5] rounded-[5px] min-h-[45px] px-[11px] flex items-center focus:outline-none focus:border-[1px] focus:border-themeColor"
                required
              />
            </div>
            <div className="grow flex flex-col gap-[7px]">
            ...
            <div className="grow flex flex-col gap-[7px]">
              ...
              <div className="bg-[#F2F5F5] rounded-[5px] min-h-[45px] px-[11px] flex  items-center">
              ...
              <div className="bg-[#F2F5F5] rounded-[5px] min-h-[45px] px-[11px] flex  items-center">
                <div className="flex flex-col item-center w-[100%]">
                  <label
                    ...
                    className={`cursor-pointer flex items-center w-full ${logoImagePreview ? "text-[black]" : "text-[#BEBEBE]"
                      }`}
                  >
                    <input
                      type="file"
            ...
            <Button
              loading={loading}
              disabled={!stripImage || !logoImage || !backgroundColor || templateName===""}
            />
          </form>
        </div>}
      </div>
